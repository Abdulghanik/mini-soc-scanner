...
print ("Welcome to Mini-SOC Vulnerability Engine! Local")
print ("Author: Abdulghani version 2.0")
print ("*****************************************\n")
stars = "*****************************************\n"
...
print("*****************************************\n")
fdesc.write("SSL Scan is Finished" + "\n")
fdesc.write(stars + "\n")
fdesc.write("SSL Scan is Fininshed")
fdesc.write(stars + "\n")

print ("Http Bad Method Vulnerabilities Check..\n")
print("*****************************************\n")
fdesc.write("Http Bad Method Vulnerabilities Check..\n")
fdesc.write(stars + "\n")
fdesc.close()

result += os.system("nmap -p80,443 --script http-methods,http-trace --script-args http-methods.test-all=true " + (
	ip) + ">> result.txt \n")
fdesc = open("result.txt", "a")

print ("Http Bad Method Vulnerabilities is Fininshed")
print("*****************************************\n")
fdesc.write("Http Bad Method Vulnerabilities is Fininshed")
fdesc.write(stars + "\n")

# Nikto Scanning for web Vulns
print ("Nikto Web Scanner Check..\n")
print("*****************************************\n")
fdesc.write("Nikto Web Scanner Check..")
fdesc.write(stars + "\n")
fdesc.close()

result += os.system("nikto -C all -h " + (ip) + ">> result.txt \n")
fdesc = open("result.txt", "a")

print ("Nikto Web Scanner is Fininshed \n")
print("***************************************** \n")
fdesc.write("Nikto Web Scanner is Fininshed \n")
fdesc.write(stars + "\n")
...
#rlogin vulnerability check port
print ("Scanning rLogin Bruteforce...")
fdesc.write("Scanning rLogin Bruteforce..." + "\n")
fdesc.close()
result+= os.system("nmap -sV -p514 --script rlogin-brute %d" %(ip) + ">> result.txt \n")

fdesc = open("result.txt","a")

print ("++ rLogin Bruteforce Completed !!!")
fdesc.write("++ rLogin Bruteforce Completed !!!" + "\n")
...
print("End of Mini-Soc Scan \n")
print("Thank You for using Mini-Soc Project \n")
fdesc.write("End of Mini-Soc Scan" + "\n")
fdesc.write("Thank You for using Mini-Soc Project" + "\n")
